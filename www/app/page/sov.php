...
<div class="page bar-top bar-btm bar-<?=$theme?>">
    <div class="container">
        ...
        <div id="sov-btnbar" style="display: none;">
            <button class="btn btn-outline btn-<?=$theme?>" data-sov="onCopy">
                Copy Table as CSV
            </button>
        </div>
        <div id="sov-output" style="display: none;"></div>
        <pre id="sov-log" class="font-monospace mb-3"></pre>
        <button class="btn btn-primary btn-<?=$theme?>" data-sov="onClaimed">
            Claimed
        </button>
        <button class="btn btn-primary btn-<?=$theme?>" data-sov="onContested">
            Contested
        </button>
    </div>
</div>
